...
public class EntitySkeletonShadow extends EntitySkeleton {
    ...
    @Override protected void dropFewItems(boolean recently_hit_by_player, DamageSource damage_source) {}
    ...
    protected void applyEntityAttributes() {
        ...
        this.setEntityAttribute(SharedMonsterAttributes.attackDamage, 15.0 + day / 15.0D);
        this.setEntityAttribute(SharedMonsterAttributes.maxHealth, 48.0 + day / 6.0D);
    }
