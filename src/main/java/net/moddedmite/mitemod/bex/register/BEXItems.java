...
public class BEXItems {
    ...
    public static final Item itemDynamicCoreInfinity = new ItemDynamicCore(Constant.getNextItemID(), BEXMaterials.infinity, 15).setUnlocalizedName("dynamic_core_infinity").setCreativeTab(tabBEX);
