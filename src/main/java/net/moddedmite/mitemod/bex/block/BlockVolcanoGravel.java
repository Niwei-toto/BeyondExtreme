...
//
//import moddedmite.rustedironcore.mixin.other.block.BlockGravelMixin;
//import net.minecraft.*;
//import net.moddedmite.mitemod.bex.util.BEXConfigs;
//
//import java.util.Random;
//
//public class BlockVolcanoGravel extends BlockGravel {
...
//            int id_dropped;
//            if (BEXConfigs.wenscConfig.BlnGravel.ConfigValue) {
